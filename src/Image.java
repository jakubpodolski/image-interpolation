...
class Image {
    ...
    public Image() {
        try {
            File input = new File("D:\\Grafika_Komputerowa\\Interpolacja\\src\\test_complex_800.png");   //należy wpisać scieżke bezwzględną do pliku
            ...
            newImageSmoothOut = new File("D:\\Grafika_Komputerowa\\Interpolacja\\out\\smoothOut.png"); //należy wpisać scieżke bezwzględną miejsca zapisu pliku
            newImageSharpOut = new File("D:\\Grafika_Komputerowa\\Interpolacja\\out\\sharpOut.png"); //należy wpisać scieżke bezwzględną miejsca zapisu pliku
            newImageInterpolation2D = new File("D:\\Grafika_Komputerowa\\Interpolacja\\out\\interpolation2D.png");
